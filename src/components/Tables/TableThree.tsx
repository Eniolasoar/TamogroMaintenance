...
const TableThree: React.FC<TableThreeProps> = ({ packageData }) => {
  return (
  ...
  <button className="group">
    <svg
      className="fill-current text-[#64748b] group-hover:text-yellow-400"
  ...
  <button className="group">
    <svg
      className="fill-current text-[#64748b] group-hover:text-red-800"
      width="18"
      height="18"
      viewBox="0 0 18 18"
      xmlns="http://www.w3.org/2000/svg"
