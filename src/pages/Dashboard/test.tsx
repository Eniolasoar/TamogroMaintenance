  ...
  return (
    ...
    {!first ? (
      ...
      {/* <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        <CardDataStats title="Total Maintenance Done" total="50" levelUp rate={''} >
          <svg
      ...
      <button className=' bg-[#09432D] p-2 rounded-md text-white'>
Create New Log
    </button>
      </div>
    ...
    <div className='mx-auto flex justify-center items-center min-h-[100vh]'>
      <button className=' bg-[#09432D] p-3 rounded-md text-white' onClick={()=>setFirst(false)}>
Create New Log
    </button>
    </div>
    }
