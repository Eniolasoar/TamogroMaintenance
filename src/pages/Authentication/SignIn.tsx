...
const { updateRole, globalState } = useGlobalContext();
useEffect(() => {
  if (role) {
    // Update the global state with the new role
    updateRole(role);
  }
}, [role, updateRole]);
    ...
    <>
      ...
      <div className="rounded-sm">
        {/* <div className="flex justify-center items-center"> */}
          ...
          <div className="w-[50%] mt-[10vh] mx-auto xl:w-1/2 ">
            <div className="w-full min-h-[50vh] p-4 sm:p-12.5 xl:p-17.5">
              {/* <span className="mb-1.5 block font-medium">Start for free</span> */}
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Sign In As <span className='text-[#09432D]'>{role}</span>
              </h2>
              ...
              <form>
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-stroke py-4 pl-6 pr-10 text-black outline-none focus:border-[#09432D] focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                    />
                ...
                <div className="mb-5">
                  <input
                    type="submit"
                    value="Sign In"
                    className="w-full cursor-pointer rounded-lg border border-[#09432D] bg-[#09432D] p-4 text-white transition hover:bg-opacity-90"
                    onClick={handlePress}
                  />
                </div>
                ...
                {/* <div className="mt-6 text-center">
                  <p>
                    ...
                    <Link to="/auth/signup" className="text-[#09432D]">
                      Sign Up
                    </Link>
                  </p>
                </div> */}
