...
const Form: React.FC<FormProps> = ({ item, onSave, onClose, buttonName }) => {
  ...
  useEffect(() => {
    setFormData((prevData) => ({ ...prevData, status: selectedStatus }));
  }, [selectedStatus]);
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 mt-[90px] ml-[300px]">
      <div className="bg-white p-3 rounded-lg shadow-lg w-[600px]">
      <h2 className="text-2xl font-bold mb-2 text-greenPrimary text-center">
...
<div>
      ...
      <div className="relative z-20 bg-white dark:bg-form-input">
        ...
        >
          ...
          <option value="Not Started" className="text-body dark:text-bodydark">
            Not Started
          </option>
